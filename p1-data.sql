-- Data prepared by Giancarlo Pernudi Segura, pernudi@ualberta.ca, revised on 27/10/2020
PRAGMA foreign_keys = ON;

insert into users values ('u001','Richard Sutton', 'password', 'Edmonton', '2018-01-05');
insert into users values ('u002','Adam White', 'password', 'Edmonton', '2018-06-02');
insert into users values ('u003','Alan Turing', 'password', 'London', '2018-02-18');
insert into users values ('u004','Linus Torvalds', 'password', 'Helsinki', '2018-10-20');
insert into users values ('u005','Richard Stallman', 'password', 'New york', '2018-12-31');
insert into users values ('u006', 'Bjarne Stroustrup', 'password', 'New York', '2019-01-01');
insert into users values ('u007', 'Ken Thompson', 'password', 'New Orleans', '2018-10-10');
insert into users values ('u008', 'Tom Lane', 'password', 'Madrid', '2018-11-30');
insert into users values ('u009', 'Dennis Ritchie', 'password', 'Bronxville', '2018-03-12');
insert into users values ('u010', 'Michael Stonebraker', 'password', 'Newburyport', '2018-09-11');
...
insert into privileged values ('u002');
insert into privileged values ('u009');
insert into privileged values ('u010');